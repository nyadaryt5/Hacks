...
|---|---|---|
| Managed-secret resolution and fail-closed behavior | `ultron-v6/ultron/secrets.py`, `ultron-v6/ultron/config.py` | `tests/test_secrets.py`, `tests/test_config.py` |
| Child credential scrubbing | `ultron-v6/ultron/coordinator.py::_tool_environment` | `tests/test_coordinator.py::test_execute_tool_does_not_inherit_operator_secrets` |
| Scope and command filtering | `ultron-v6/ultron/safety.py`, `ultron-v6/ultron/scope.py` | `tests/test_safety.py`, `tests/test_scope.py` |
| Budget/rate limits | `ultron-v6/ultron/budget.py`, `ultron-v6/ultron/llm.py` | `tests/test_budget.py`, `tests/test_llm.py` |
| Bounded agent loop | `ultron-v6/ultron/coordinator.py`, `ultron-v6/ultron/fsm.py` | `tests/test_coordinator.py`, `tests/test_fsm.py` |
| Dependency drift/audit | `scripts/lockfiles.py`, `.github/workflows/ci.yml` | `make lockfile-check`, CI security jobs |
| Structured logs without required telemetry | `ultron-v6/ultron/logging_setup.py`, `ultron-v6/ultron/errors.py` | `tests/test_logging.py`, `tests/test_errors.py` |
